...
class DeathZoneEntityCreator(
    ...
    fun createInvisibleDeathZone(rectangle: Rectangle): DeathZoneEntity {
        ...
        val genericCustomization = preset.genericCustomization
        return engine.createEntity().apply {
            createPositionAndForm(rectangle)
            generateNonGeneralComponents(genericCustomization)
    ...
    private fun Entity.generateNonGeneralComponents(genericCustomization: GenericEntityCustomization) {
